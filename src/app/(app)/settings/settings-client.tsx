...
function ProfileSection({ initialUser }: { initialUser: User }) {
  ...
  const { data: userData } = trpc.user.me.useQuery(undefined, { refetchOnWindowFocus: false });
...
const VALID_SECTIONS = new Set<Section>(["profile", "appearance", "capture", "integrations", "ai", "backups", "data", "account"]);
