...
const AUDITED_ENTITIES = new Set(["AuthEvent", "User", "Task", "Project", "ProjectFolder", "Capture", "EmailCapture", "Attachment", "Note", "NotesFolder", "Table", "TablesFolder", "TaskTemplate"]);
