...
export function CurrencyCell({
  ...
  if (isEditing) {
    return (
      <div className="absolute inset-0 flex items-center bg-surface-base ring-2 ring-inset ring-accent-primary">
        ...
        <input
          ...
          className="flex-1 bg-transparent px-1 py-1 text-right font-ui text-sm text-text-primary focus:outline-none"
        />
      </div>
    );
  }
